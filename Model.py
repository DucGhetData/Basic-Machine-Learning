...
# Đọc file csv và lưu vào df
df = pd.read_csv("F:\\Python 101\\Predicting house price\\BTL\\df_cleaned.csv")

# Ta sẽ thực hiện một chút thay đổi với dataframe
...
# Nếu bạn cũng muốn làm với df_test thì tương tự
...
# Lưu mô hình dự đoán
joblib.dump(RF,"F:\\Python 101\\Predicting house price\\BTL\\RF_model.pkl")
